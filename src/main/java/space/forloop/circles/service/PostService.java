...
/**
 * Handles creating new posts under specific circles. All methods require the user be at least a member of the circle
 * otherwise a forbidden exception is returned.
 *
