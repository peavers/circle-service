...
/**
 * Handles CRUD operations with Circles. Circles represent a space where a person can invite their friends to post and
 * share messages.
 *
...
public class CircleController {
    ...
    /**
     * Creates a new circle. The person who calls this endpoint becomes the owner, and the first user of the Circle.
     *
    ...
    /**
     * Returns all details we have about a single {@link Circle}. The circleId of the {@link Circle} must be passed as a
     * path param on the GET request.
     *
